...
# Variables for Google Page Speed
NPS_VER=1.9.32.1
...
# Step 2. Download for Google Page Speed
function download_pagespeed {
	git clone https://github.com/pagespeed/ngx_pagespeed.git \
	&& cd ngx_pagespeed && git checkout -b release-$NPS_VER-beta origin/release-$NPS_VER-beta \
	&& curl -LO "https://dl.google.com/dl/page-speed/psol/$NPS_VER.tar.gz" \
	&& tar xzvf $NPS_VER.tar.gz && cd ..
	sleep 5
	echo -ne "\033[33m - Step 2. Download for Google PageSpeed: [\033[0m"
	echo -ne "\033[32m Complete\033[0m"
	echo -ne "\033[33m ]\033[0m \n"
	echo ""
}

# Step 3. Build for OpenResty
function build_openresty {
	...
	sleep 5
	echo -ne "\033[33m - Step 3. Build for OpenResty: [\033[0m"
	echo -ne "\033[32m Complete\033[0m"
	echo -ne "\033[33m ]\033[0m \n"
	echo ""
}
...
unset NPS_VER OPENRESTY_UGID OPENRESTY_PREFIX \
